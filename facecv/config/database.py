...
class DatabaseConfig:
    ...
    def _ensure_directories(self):
        """确保所有必要目录存在"""
        directories = [self.base_data_dir, self.db_dir, self.get_chromadb_path()]
    ...
    def from_env(cls) -> "DatabaseConfig":
        ...
        mysql_password = (
            os.getenv("FACECV_MYSQL_PASSWORD") if facecv_mysql_password_set else os.getenv("MYSQL_PASSWORD", "")
        )
        ...
        return cls(
            ...
            chromadb_collection_name=os.getenv("FACECV_CHROMADB_COLLECTION_NAME")
            or os.getenv("CHROMADB_COLLECTION_NAME", "face_embeddings"),
            # 连接池配置

...
class FaceRecognizer:
    ...
    def __init__(self, model: str = "insightface", db_type: str = None, db_connection: str = None, **kwargs):
        """
        初始化人脸识别器
    ...
    def register(self, image: Union[str, np.ndarray, Image.Image], name: str, metadata: Dict = None) -> List[str]:
        """
        注册人脸
    ...
    def recognize(self, image: Union[str, np.ndarray, Image.Image], threshold: float = None) -> List[RecognitionResult]:
        """
        识别图片中的人脸
    ...
    def verify(
        ...
        return VerificationResult(
            is_same_person=similarity >= threshold, similarity_score=similarity, threshold=threshold
        )
